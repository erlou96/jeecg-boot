...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
		...
		// 配置不会被拦截的链接 顺序判断
		filterChainDefinitionMap.put("/spark/**", "anon");
		filterChainDefinitionMap.put("/database/**", "anon");
		filterChainDefinitionMap.put("/new/**", "anon");
		filterChainDefinitionMap.put("/hdfs/**", "anon");
		filterChainDefinitionMap.put("/HDFSbBackup/**", "anon");
